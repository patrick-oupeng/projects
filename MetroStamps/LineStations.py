...
LINE_NODES['板南線'] = ['南港展覽館', '南港', '昆陽', '後山埤', '永春', '市政府', '國父紀念館', '忠孝敦化', '忠孝復興', '忠孝新生', '善導寺', '台北車站', '西門', '龍山寺', '江子翠', '新埔', '板橋', '府中', '亞東醫院', '海山', '土城', '永寧', '頂埔']
LINE_NODES['環狀線'] = ['新北產業園區', '幸福', '頭前庄','新埔民生','板橋','板新','中原','橋和','中和','景安','景平','秀朗橋','十四張','大坪林']
